...
public class CrossborderTransfer {
	...
	public String toString() {
		return "CrossborderTransfer [cid=" + cid + ", userid=" + userid + ", username=" + username + ", useraddr="
				...
				+ ", exchangeyid=" + exchangeyid + ", moneynumber=" + moneynumber + ", message=" + message
				+ ", datetime=" + datetime + ", status=" + status + ", fee=" + fee + ", service=" + service
				+ ", deletetype=" + deletetype + ", uptime=" + uptime + "]";
	}
