...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>跨行账单状态修改</legend>
</fieldset>
 
<form class="layui-form" action="${pageContext.request.contextPath }/TransferAudit/updateInterbank" id="changeForm">
	    <div class="layui-form-item">
 	
	<label class="layui-form-label">&emsp;</label>
	   <input type="hidden" name="iid" id="iid" value="${iit.iid}"/>
		 	<input type="hidden" name="userid"  value="${iit.userid}"/>
			...
			<div class="layui-input-inline">
				...
				<input type="text" name="money" autocomplete="off" class="layui-input" value="${iit.money}"  readonly="readonly">
			</div>

			<div class="layui-input-inline">
				 <label class="layui-form-label">服务费:</label>
				<input type="text" name="fee" autocomplete="off" class="layui-input" value="${iit.fee}"  readonly="readonly">
			</div>
  		<label class="layui-form-label">&emsp;</label>
  		<div class="layui-form-item">
