		...
		<from class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="radio" name="bj" title="开通" checked>
					<input type="radio" name="bj" title="关闭">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="title" placeholder="请输入金额" class="layui-input" style="width: 220px;">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">日累计交易限额：</label>
				<div class="layui-input-block">
					<input type="text" name="r" placeholder="请输入金额" class="layui-input" style="width: 220px;">
				</div>
			</div>
			<div class="layui-form-item">
