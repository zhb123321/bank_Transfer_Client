...
public class InterbankTransfer {
	...
	public String toString() {
		return "InterbankTransfer [iid=" + iid + ", userid=" + userid + ", inaccount=" + inaccount + ", bankname="
				+ bankname + ", bankname2=" + bankname2 + ", outaccount=" + outaccount + ", username=" + username
				+ ", money=" + money + ", datetime=" + datetime + ", status=" + status + ", transfertype="
				+ transfertype + ", balance=" + balance + ", fee=" + fee + ", currencyid=" + currencyid + ", model="
				+ model + ", postscript=" + postscript + ", service=" + service + ", deletetype=" + deletetype
				+ ", uptime=" + uptime + "]";
	}
