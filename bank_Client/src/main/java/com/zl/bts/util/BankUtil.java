...
public class BankUtil {
    ...
    public static String BankResult(String acct_pan,String acct_name,String phone_num,String cert_id) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException {
    	...
    	//云市场分配的密钥Id
        String secretId = "AKID515pPb16bd3Z53tavm13bUsdiadg1F1wsjtE";
        //云市场分配的密钥Key
        String secretKey = "7wzy3uotqzhomO2x4zzOimw3qgl1xC0ck6qD7ao";
        ...
        // url参数拼接
        String url = "https://service-cia17681-1255468759.ap-shanghai.apigateway.myqcloud.com/release/bank4";
