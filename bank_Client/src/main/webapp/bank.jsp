	...
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header layui-bg-blue" id="sss" name="sss">
			...
			<ul class="layui-nav layui-layout-right">
				<li class="layui-nav-item"><a href="javascript:;"> ${acc.realname} </a>
					<dl class="layui-nav-child">
						<dd>
				...
				<li class="layui-nav-item layui-hide-xs" lay-unselect><a
					...
					<dl class="layui-nav-child">
						<dd>
							<a href="javascript:;" onclick="gaib(this.name)"
								name="layui-bg-orange">橙色</a>
						</dd>
						<dd>
							<a href="javascript:;" onclick="gaib(this.name)"
								name="layui-bg-red">赤色</a>
						</dd>
						<dd>
							<a href="javascript:;" onclick="gaib(this.name)"
								name="layui-bg-green">墨绿</a>
						</dd>
						<dd>
							<a href="javascript:;" onclick="gaib(this.name)"
								name="layui-bg-cyan">藏青</a>
						</dd>
						<dd>
							<a href="javascript:;" onclick="gaib(this.name)"
								name="layui-bg-blue">蓝色</a>
						</dd>
						<dd>
							<a href="javascript:;" onclick="gaib(this.name)"
								name="layui-bg-black">雅黑</a>
						</dd>
						<dd>
							<a href="javascript:;" onclick="gaib(this.name)"
								name="layui-bg-gray">银灰</a>
						</dd>
					</dl></li>
			</ul>
		</div>
