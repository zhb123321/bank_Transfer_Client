...
<form class="layui-form" action="/cac/addCapitalAggregateInLine" method="post">
  ...
  <div class="layui-form-item">
    ...
    <label class="layui-form-label">开户行:</label>
    <div class="layui-input-inline">
      <input type="text" name="outbankname" value="爱存不存银行" required  lay-verify="required" placeholder="请输入银行卡开户行" autocomplete="off" class="layui-input">
    </div>
    <label class="layui-form-label">持卡人姓名:</label>
    <div class="layui-input-inline">
      <input type="text" name="title"  value="liwutong" placeholder="请输入持卡人姓名" autocomplete="off" class="layui-input">
    </div>
  </div><br />
  ...
  <div class="layui-form-item">
    ...
    <label class="layui-form-label">保留金额</label>
    <div class="layui-input-inline">
      <input type="text" name="balanceupper" id="bao2"   placeholder="只能输入1元" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-form-item">
