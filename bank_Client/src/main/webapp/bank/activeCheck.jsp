...
<body>
<input type="hidden" value="${entity.aid}" id="aid"/>
...
//查询收款账户信息
	$("#confirm_1").click(function(){
		...
		var aid=$("#aid").val();
		$.ajax({	
	        url:"${pageContext.request.contextPath}/active/checkMessage",
	        data:{"message":message},
	        dataType:"json",
	        success: function(result){
	        	if(result.code=="0"){
	        		$("#check_1").show();
	        		window.location.href="${pageContext.request.contextPath}/successActive?aid="+aid;	
	        	}else{
	        		$("#check_2").show();
	        	}
	        }
